...
meta =
{
  ...
  title = "Use Gate Order",

  -- Type of your mod, either "mod" or "factionpack"
  type = "mod",

  -- Description of your mod that will be displayed to players
  description = "Makes it possible to order ships to use gates and wormholes.\n\nWarning: this is a modded version of Fleet Jump Order (CraftOrderLib compatible), you have to disable Fleet Jump Order in order for this mod to work properly.",
  ...
  -- },
  dependencies = {
    {id = "1837703287", min = "1.2"},
    {id = "Avorion", min = "0.27", max = "1.0"}
  },
